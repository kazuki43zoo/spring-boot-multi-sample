...
ln -f -s ${HOME}/apps/SqsCredentials.properties ${HOME}/apps/${VERSION}/SqsCredentials.properties
...
sudo ln -f -s ${HOME}/apps/${VERSION}/jms-consumer.jar /etc/init.d/boot-jms-c
